...
<body>
	<section class="landing">
		<aside class="landing">
			...
			<span style="display: none;" id="c-sharp">I have a bit of experience coding in C#. Originally, I was supposed to develop scripts in C#, so I took it upon myself to learn C# following a tutorial online. I did a couple of programming tasks as well. However, due to a change in plans, I didn't get to apply my knowledge.</span>
			...
			<span style="display: none;" id="music-production">I have produced some simple tracks using FL Studio and Garage Band. And, if count it, I've done some mixing and tweaking using MuseScore.</span>
			...
			<span style="display: none;" id="php">I've attended the Fullstack Web Development course which taught PHP programming.</span>
			...
			<span style="display: none;" id="fullstack">The course teaches beginner to advanced concepts in HTML, CSS, JavaScript, Python, Wagtail CMS, PHP and MySQL. A complete course in Web Development from a very reputable teacher.</span>
